...
const Navbar = () => {
  return (
    <>
      ...
      <nav className="w-full fixed px-4 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 font-ovo">
        <a href="#top">
          <Image
            src={assets.logo}
            alt="logo"
        ...
        <ul className="hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-4 bg-white shadow-sm opacity-70">
          <li>
            <a href="#top">Home</a>
          </li>
          <li>
